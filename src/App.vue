<template>
  <div id="app" class="contain">
    <GamestateStart v-if="uiState==='start'">
        ...
        <p v-for = "char in characterChoices" :key="char" class="character-choices">
          <input type="radio" :id="char" :value="char" v-model="characterInput"/>   
    ...
    <g id="alienbubble">
      ...
      <div class="zombietalk">
        <p v-for="char in characterChoices" :key="char">
           <button @click="pickAnswer(char)">{{questions[questionIndex][char]}} </button>
        </p>
